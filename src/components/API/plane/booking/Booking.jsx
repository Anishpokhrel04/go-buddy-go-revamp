...
const Booking = () => {
  ...
  var price = nprValue *(items?.adultCount+ items?.childCount);
  var surcharge = 0;
  var tax = price * 0.13;
  ...
  return (
    <>
      {showPage ? (
        <>
          <div className="timer">
            <p>Please fill the form in {formatTime(remainingTime)} minutes</p>
          </div>
            ...
            <div className="passenger-details">
              ...
              <input
                ...
                placeholder={`Total Passenger: ${
                  items.adultCount + items.childCount
                }`}
              />
