...
const BusBooking = () => {
  ...
  const clickNavigate = () => {
    localStorage.setItem("busticketSeats", JSON.stringify(selectedSeats));
    localStorage.setItem(
      "busticketTotalPrice",
      JSON.stringify(calculateTotalPrice())
    );
      ...
      <div className="booking-div">
        <div className="first-div">
          ...
          <div className="seat-card">
            <h4>Seat Legend</h4>
            <div className="string-seat">
              <div className="image-div">
                <PiSteeringWheelLight className="icon" />
                <p>Driver</p>
              </div>
              <div className="image-div">
              ...
              <div className="image-div">
                <MdAirlineSeatReclineNormal className="icon available" />
                <p>Available</p>
              </div>
              <div className="image-div">
                <MdAirlineSeatReclineNormal className="icon booked" />
                <p>Booked</p>
              </div>
            </div>
          </div>
